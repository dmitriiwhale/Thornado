  ...
  return (
    <div ref={containerRef} className="relative w-full rounded-xl">
      <div className="flex items-baseline justify-between">
        ...
        <span className="font-mono text-lg tabular-nums text-sky-200">
          {displayPrice}
        </span>
      </div>
      <div
      ...
      <div className="mt-3 border-t border-sky-400/12 pt-2">
        <div className="text-[10px] font-medium uppercase tracking-wider text-sky-400/60 mb-1.5">
          Price history
        </div>
              ...
              >
                ...
                <span
                  className={`tabular-nums ${
                    entry.up ? 'text-emerald-400' : 'text-red-400'
                  }`}
                >
                  {entry.up ? '+' : ''}
