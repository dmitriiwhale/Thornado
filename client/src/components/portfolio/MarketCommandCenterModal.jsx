      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col divide-y divide-white/[0.08]">
          ...
          <div ref={listRef} className="min-h-0 flex-1 overflow-y-auto">
            ...
            <div className="sticky top-0 z-10 flex border-b border-white/[0.06] bg-[rgba(12,14,32,0.96)] px-1.5 py-2 text-[11px] uppercase tracking-wide text-slate-500 backdrop-blur-sm sm:px-4">
                ...
                {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                  ...
                  return (
                    <div
                      ...
                      className="absolute left-0 top-0 flex w-full cursor-pointer items-center border-b border-white/[0.05] px-1.5 py-2 transition hover:bg-white/[0.04] sm:px-4"
                      style={{
